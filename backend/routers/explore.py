...
async def list_tickets(
    ...
    for r in rows:
        ...
        result.append({
            ...
            "travel_class":    r.travel_class or "economy",
            "is_nonstop":      r.is_nonstop if r.is_nonstop is not None else True,
            "layovers":        r.layovers or [],
            "departure_point": r.departure_point or "",
            "pickup_points":   r.pickup_points or [],
            "amenities":       r.amenities or [],
            "notes":           r.notes or "",
            "contact_phone":   r.contact_phone or "",
            "contact_whatsapp":r.contact_whatsapp or "",
